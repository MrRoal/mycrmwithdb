...
$organization_name = str_replace('.od1.mycrm.com', '', $organization_name);
...
if (isset($_REQUEST['service'])) {
	...
	$cronTasks = array(Mycrm_Cron::getInstance($_REQUEST['service']));
}
else {
	// Run all service
	$cronTasks = Mycrm_Cron::listAllActiveInstances();
}
