...
jQuery.Class('Settings_LayoutEditor_Js', {
	...
	setFieldDetails : function(result, form) {
		...
		var fieldModel = Mycrm_Field_Js.getInstance(result);
		...
		defaultValueUi.find('[data-validation-engine]').attr('data-validation-engine','validate[required,funcCall[Mycrm_Base_Validator_Js.invokeValidation]]');
...
Mycrm_WholeNumberGreaterThanZero_Validator_Js("Mycrm_FloatingDigits_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Mycrm_FloatingDigits_Validator_Js();
...
Mycrm_WholeNumberGreaterThanZero_Validator_Js("Mycrm_DecimalMaxLength_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Mycrm_DecimalMaxLength_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
...
Mycrm_WholeNumberGreaterThanZero_Validator_Js("Mycrm_MaxLength_Validator_Js",{
...
Mycrm_Base_Validator_Js("Mycrm_PicklistFieldValues_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new Mycrm_PicklistFieldValues_Validator_Js();
		instance.setElement(field);
		var response = instance.validate();
		if(response != true){
			return instance.getError();
