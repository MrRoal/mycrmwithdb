 ...
 * All Rights Reserved.
 *************************************************************************************/
Mycrm_AdvanceFilter_Js('Workflows_AdvanceFilter_Js',{},{
...
Mycrm_Field_Js('Workflows_Field_Js',{},{
...
Mycrm_Date_Field_Js('Workflows_Date_Field_Js',{},{
	...
	getUi : function() {
		...
		if(comparatorSelectedOptionVal.length > 0) {
			if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
				...
				var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
...
Mycrm_Date_Field_Js('Workflows_Datetime_Field_Js',{},{
	/**
	 * Function to get the user date format
	 */
	getDateFormat : function(){
...
Mycrm_Currency_Field_Js('Workflows_Currency_Field_Js',{},{
...
Mycrm_Time_Field_Js('Workflows_Time_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Percentage_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Text_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Boolean_Field_Js',{},{
...
Mycrm_Owner_Field_Js('Workflows_Owner_Field_Js',{},{
...
Mycrm_Picklist_Field_Js('Workflows_Picklist_Field_Js',{},{
