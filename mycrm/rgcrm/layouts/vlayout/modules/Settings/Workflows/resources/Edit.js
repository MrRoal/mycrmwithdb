 ...
 * All Rights Reserved.
 *************************************************************************************/
Settings_Mycrm_Edit_Js("Settings_Workflows_Edit_Js",{
	...
	registerPopUpSaveEvent : function(data,fieldUiHolder) {
		jQuery('[name="saveButton"]',data).on('click',function(e){
            ...
            if(valueType != 'rawtext'){
                ...
                fieldValueElement.removeClass('validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]');
            }else{
                fieldValueElement.addClass('validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]');
                fieldValueElement.attr('data-validation-engine','validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]');
            }
