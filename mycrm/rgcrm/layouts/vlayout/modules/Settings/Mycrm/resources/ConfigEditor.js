...
jQuery.Class("Settings_Mycrm_ConfigEditor_Js",{},{
...
jQuery(document).ready(function(e){
	var tacInstance = new Settings_Mycrm_ConfigEditor_Js();
	tacInstance.registerEvents();
})

Mycrm_WholeNumberGreaterThanZero_Validator_Js("Mycrm_NumberRange5_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Mycrm_NumberRange5_Validator_Js();
...
Mycrm_WholeNumberGreaterThanZero_Validator_Js("Mycrm_NumberRange100_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Mycrm_NumberRange100_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
