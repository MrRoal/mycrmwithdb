	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="https://www.mycrm.com">Mycrm Website</a> | 
						<a href="https://wiki.mycrm.com/mycrm6/">Mycrm Wiki</a> | 
						<a href="https://www.mycrm.com/crm/videos/">Mycrm videos </a> | 
						<a href="https://discussions.mycrm.com/">Mycrm Forums</a> 
					</div>
				</div>
			</div>
			<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2> Get more out of Mycrm </h2></div>
										<ul class="bxslider">
											<li>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login to Mycrm CRM</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
												...
												<img src='//stats.mycrm.com/stats.php?uid={$APPUNIQUEKEY}&v={$CURRENT_VERSION}&type=U' alt='' title='' border=0 width='1px' height='1px'>
											</form>
											<div class="login-subscript">
												<small> Powered by mycrm CRM {$CURRENT_VERSION}</small>
											</div>
				</div>
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									<a href="https://www.mycrm.com"> mycrm.com</a> | 
									<a href="https://www.mycrm.com/LICENSE.txt">Read License</a> | 
									<a href="https://www.mycrm.com/products/crm/privacy_policy.html">Privacy Policy</a> </small>
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('LBL_CONNECT_WITH_US', $MODULE)}&nbsp;</small>
								<a href="https://www.facebook.com/mycrm"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/mycrmcrm"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/company/mycrm-systems-india-pvt-ltd"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="http://www.youtube.com/user/mycrmcrm"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
