...
Reports_Detail_Js("Reports_ChartDetail_Js",{
	...
	registerEventForChartGeneration : function() {
		...
		try {
			...
			jQuery('#chartcontent').trigger(Mycrm_Widget_Js.widgetPostLoadEvent);
		} catch(error) {
			console.log("error");
			console.log(error);
...
Mycrm_Pie_Widget_Js('Report_Piechart_Js',{},{
...
Mycrm_Barchat_Widget_Js('Report_Verticalbarchart_Js', {},{
