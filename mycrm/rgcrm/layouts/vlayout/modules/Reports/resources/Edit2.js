...
Reports_Edit_Js("Reports_Edit2_Js",{},{
	...
	registerLineItemCalculationLimit : function() {
		...
		if(jQuery.inArray(primaryModule, inventoryModules) !== -1 || secondaryIsInventory) {
			jQuery('.CalculationFields').on('change', 'input[type="checkbox"]', function(e) {
				...
				var reg = new RegExp(/cb:mycrm_inventoryproductrel*/);
				var attr = element.is(':checked');
				var moduleCalculationFields = jQuery('.CalculationFields input[type="checkbox"]').not('[value^="cb:mycrm_inventoryproductrel"]');
				var lineItemCalculationFields = jQuery('.CalculationFields').find('[value^="cb:mycrm_inventoryproductrel"]');
	...
	registerLineItemCalculationLimitOnLoad : function() {
		var moduleCalculationFields = jQuery('.CalculationFields input[type="checkbox"]').not('[value^="cb:mycrm_inventoryproductrel"]');
		var lineItemFields = jQuery('.CalculationFields').find('[value^="cb:mycrm_inventoryproductrel"]');
