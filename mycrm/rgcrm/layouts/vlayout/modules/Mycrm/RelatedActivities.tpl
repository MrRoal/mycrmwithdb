		...
		{if count($ACTIVITIES) neq '0'}
			{foreach item=RECORD key=KEY from=$ACTIVITIES}
				...
				<div class="activityEntries">
					...
					<div class="row-fluid">
						<span class="span6"><strong title="{Mycrm_Util_Helper::formatDateTimeIntoDayString("$START_DATE $START_TIME")}">{Mycrm_Util_Helper::formatDateIntoStrings($START_DATE, $START_TIME)}</strong></span>
