...
jQuery.Class("Mycrm_Header_Js", {
    ...
    getQuickCreateForm: function(url, moduleName, params) {
        ...
        if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
            if (typeof Mycrm_Header_Js.quickCreateModuleCache[moduleName] != 'undefined') {
                aDeferred.resolve(Mycrm_Header_Js.quickCreateModuleCache[moduleName]);
        ...
        AppConnector.request(requestParams).then(function(data) {
            if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
                Mycrm_Header_Js.quickCreateModuleCache[moduleName] = data;
            }
...
//        }
    ...
    registerCalendarButtonClickEvent: function() {
        ...
        var mycrmDateFormat = app.convertToDatePickerFormat(dateFormat);
    ...
    handleQuickCreateData: function(data, params) {
        ...
        app.showModalWindow(data, function(data) {
            ...
            var editViewInstance = Mycrm_Edit_Js.getInstanceByModuleName(moduleName);
        ...
        form.on('submit', function(e) {
            ...
            if (typeof form.data('submit') != "undefined") {
                ...
                if (!(recordPreSaveEvent.isDefaultPrevented())) {
                    ...
                    var moduleInstance = Mycrm_Edit_Js.getInstanceByModuleName(module);
                    ...
                    targetInstance.quickCreateSave(form).then(
                            function(data) {
                                ...
                                if((module == parentModule) && (viewname=="List")){ 
                                    var listinstance = new Mycrm_List_Js(); 
    ...
    labelSearch: function(currentTarget) {
        ...
        var basicSearch = new Mycrm_BasicSearch_Js();
    ...
    registerEvents: function() {
		...
		if(jQuery.browser.msie && jQuery.browser.version < 9.0) {
			if(app.getCookie('oldbrowser') != 'true') {
				...
				window.location.href = 'layouts/vlayout/modules/Mycrm/browsercompatibility/Browser_compatibility.html';
			}
		}

        jQuery('#globalSearch').click(function() {
            var advanceSearchInstance = new Mycrm_AdvanceSearch_Js();
		...
		$(document).ajaxComplete(function() {
			 Mycrm_Header_Js.getInstance().adjustContentHeight();
		});
...
jQuery(document).ready(function() {
    ...
    Mycrm_Header_Js.getInstance().registerEvents();
