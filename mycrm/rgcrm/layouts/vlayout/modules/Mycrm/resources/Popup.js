...
jQuery.Class("Mycrm_Popup_Js",{
    ...
    getInstance: function(){
		...
		var fallbackClassName = Mycrm_Popup_Js;
	...
	show : function(urlOrParams, cb, windowName, eventName, onLoadCb){
		...
		if(typeof cb != 'undefined') {
		 ...
		 if(typeof onLoadCb == 'function') {
			jQuery.windowMsg('Mycrm.OnPopupWindowLoad.Event', function(data){
				onLoadCb(data);
            })
        }
	...
	getPageRecords : function(params){
		...
		Mycrm_BaseList_Js.getPageRecords(params).then(
				function(data){
