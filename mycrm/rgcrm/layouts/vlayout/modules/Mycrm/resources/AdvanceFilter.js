...
jQuery.Class("Mycrm_AdvanceFilter_Js",{
	
	getInstance: function(container){
		var module = app.getModuleName();
		var moduleClassName = module+"_AdvanceFilter_Js";
		var fallbackClassName = "Mycrm_AdvanceFilter_Js";
	...
	loadFieldSpecificUi : function(fieldSelect) {
		...
		var fieldModel = Mycrm_Field_Js.getInstance(fieldInfo,moduleName);
	...
	addValidationToFieldIfNeeded : function(selectFieldElement) {
		...
		if(this.isFieldSupportsValidation(selectFieldElement)) {
			...
			fieldSpecificElement.addClass('validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]')
								.attr('data-validation-engine','validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]')
								.attr('data-fieldinfo', JSON.stringify(selectedOption.data('fieldinfo')));
            if(typeof validator!='undefined') {
                fieldSpecificElement.attr('data-validator',validator);
            }
		}else{
			fieldSpecificElement.removeClass('validate[funcCall[Mycrm_Base_Validator_Js.invokeValidation]]')
...
Mycrm_Field_Js('AdvanceFilter_Field_Js',{},{
...
Mycrm_Picklist_Field_Js('AdvanceFilter_Picklist_Field_Js',{},{
...
Mycrm_Multipicklist_Field_Js('AdvanceFilter_Multipicklist_Field_Js',{},{
...
Mycrm_Owner_Field_Js('AdvanceFilter_Owner_Field_Js',{},{
...
Mycrm_Date_Field_Js('AdvanceFilter_Date_Field_Js',{},{
	/**
