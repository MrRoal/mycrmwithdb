...
jQuery.Class('Mycrm_Widget_Js',{

	widgetPostLoadEvent : 'Vtiget.Dashboard.PostLoad',
	widgetPostRefereshEvent : 'Mycrm.Dashboard.PostRefresh',
	...
	getInstance : function(container, widgetName, moduleName) {
		...
		var fallbackClass = window["Mycrm_"+widgetClassName+"_Widget_Js"];

		var basicClass = Mycrm_Widget_Js;
	...
	refreshWidget : function() {
		...
		AppConnector.request(params).then(
			function(data){
				...
				contentContainer.html(data).trigger(Mycrm_Widget_Js.widgetPostRefereshEvent);
			},
			function(){
				refreshContainer.progressIndicator({'mode': 'hide'});
			}
	...
	registerWidgetPostLoadEvent : function(container) {
		var thisInstance = this;
		container.on(Mycrm_Widget_Js.widgetPostLoadEvent, function(e) {
	...
	registerWidgetPostRefreshEvent : function(container) {
		var thisInstance = this;
		container.on(Mycrm_Widget_Js.widgetPostRefereshEvent, function(e) {
...
Mycrm_Widget_Js('Mycrm_History_Widget_Js', {}, {
...
Mycrm_Widget_Js('Mycrm_Funnel_Widget_Js',{},{
...
Mycrm_Widget_Js('Mycrm_Pie_Widget_Js',{},{
...
Mycrm_Widget_Js('Mycrm_Barchat_Widget_Js',{},{
...
Mycrm_Widget_Js('Mycrm_MultiBarchat_Widget_Js',{
...
Mycrm_Widget_Js('Mycrm_Minilist_Widget_Js', {}, {
...
Mycrm_Widget_Js('Mycrm_Tagcloud_Widget_Js',{},{
...
/* Notebook Widget */
Mycrm_Widget_Js('Mycrm_Notebook_Widget_Js', {
