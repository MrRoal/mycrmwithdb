...
Mycrm_BasicSearch_Js("Mycrm_AdvanceSearch_Js",{
	...
	getAdvanceSearch : function() {
		...
		//Exists in the cache
		if(searchModule in Mycrm_AdvanceSearch_Js.cache) {
			aDeferred.resolve(Mycrm_AdvanceSearch_Js.cache[searchModule]);
			return aDeferred.promise();
		}
        
        //if you are in settings then module should be mycrm
		...
		AppConnector.request(searchableModulesParams).then(
			function(data){
				...
				//add to cache
				Mycrm_AdvanceSearch_Js.cache[searchModule] = data;
	...
	initiateSearch : function() {
		...
		var postLoad = function(uiData) {
			...
			thisInstance.advanceFilter = new Mycrm_SearchAdvanceFilter_Js(jQuery('.filterContainer',uiData));
