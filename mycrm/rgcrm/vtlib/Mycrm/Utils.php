 ...
 */
class Mycrm_Utils {
    protected static $logFileName = 'mycrmmodule.log';
	...
	static function Log($message, $delimit=true) {
		global $Mycrm_Utils_Log, $log;
		
		$log->debug($message);
		if(!isset($Mycrm_Utils_Log) || $Mycrm_Utils_Log == false) return;
	...
	static function CheckTable($tablename) {
		...
		$tablename = Mycrm_Utils::SQLEscape($tablename);
