...
/**
 * Provides API to package mycrm CRM layout files.
 * @package vtlib
 */
class Mycrm_LayoutExport extends Mycrm_Package {
    const TABLENAME = 'mycrm_layout';
    ...
    function __initExport($layoutName) {
            ...
            Mycrm_Utils::checkFileAccessForInclusion("layouts/$layoutName/skins/mycrm/style.less");
    ...
    function export_Layout($layoutName) {
            ...
            $sqlresult = $adb->pquery("SELECT * FROM mycrm_layout WHERE name = ?", array($layoutName));
