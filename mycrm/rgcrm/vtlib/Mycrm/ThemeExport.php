...
/**
 * Provides API to package mycrm CRM language files.
 * @package vtlib
 */
class Mycrm_ThemeExport extends Mycrm_Package {
    const TABLENAME = 'mycrm_layoutskins';
    ...
    function __initExport($layoutName, $themeName) {
            ...
            Mycrm_Utils::checkFileAccessForInclusion("layouts/$layoutName/skins/$themeName/style.less");
    ...
    function export_Theme($layoutName, $themeName) {
            ...
            $sqlresult = $adb->pquery("SELECT * FROM mycrm_layoutskins WHERE name = ?", array($themeName));
    ...
    static function __initSchema() {
            $hastable = Mycrm_Utils::CheckTable(self::TABLENAME);
            if(!$hastable) {
