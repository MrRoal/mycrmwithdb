...
class Mycrm_PDF_Generator {
	...
	function __construct() {
		$this->pdf = new Mycrm_PDF_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);
	...
	function createLastPage() {
		...
		if ($totalHeightFooter) {
			$this->footerFrame = new Mycrm_PDF_Frame();
	...
	function createPage($isLastPage = false) {
		...
		if ($totalHeightHeader) {
			$this->headerFrame = new Mycrm_PDF_Frame();
		...
		// ContentViewer
		$this->contentFrame = new Mycrm_PDF_Frame();
