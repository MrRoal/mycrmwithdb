 ...
 * @package vtlib
 */
class Mycrm_LanguageExport extends Mycrm_Package {

	const TABLENAME = 'mycrm_language';
	...
	function __initExport($languageCode, $moduleInstance = null) {
		...
		Mycrm_Utils::checkFileAccessForInclusion("languages/$languageCode/Mycrm.php");
	...
	function export_Language($prefix) {
		...
		$sqlresult = $adb->pquery("SELECT * FROM mycrm_language WHERE prefix = ?", array($prefix));
