...
include_once 'modules/Mycrm/CRMEntity.php';

class ModuleName extends Mycrm_CRMEntity {
	var $table_name = 'mycrm_<modulename>';
	var $table_index= '<modulename>id';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('mycrm_<modulename>cf', '<modulename>id');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('mycrm_crmentity', 'mycrm_<modulename>', 'mycrm_<modulename>cf');
	...
	var $tab_name_index = Array(
		...
		'mycrm_<modulename>' => '<modulename>id',
		'mycrm_<modulename>cf'=>'<modulename>id');
