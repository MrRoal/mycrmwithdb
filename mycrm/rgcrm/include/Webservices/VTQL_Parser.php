...
#line 451 "e:\workspace\nonadmin\pkg\mycrm\extensions\Webservices\VTQL_parser.y"
class VTQL_Parser#line 102 "e:\workspace\nonadmin\pkg\mycrm\extensions\Webservices\VTQL_parser.php"
{
...
Array ( 
	...
	[tableName] => mycrm_crmentity,mycrm_contactdetails,mycrm_contactaddress,mycrm_contactsubdetails,mycrm_contactscf,mycrm_customerdetails 
...
if($firstTable!=$table){
	if(!isset($tabNameIndex[$table]) && $table == "mycrm_crmentity"){
