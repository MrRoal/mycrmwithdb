...
require_once 'include/Webservices/MycrmCRMActorMeta.php';
class MycrmActorOperation extends WebserviceEntityOperation {
	...
	protected function getMetaInstance(){
		if(empty(WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id])){
			WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id]  
					= new MycrmCRMActorMeta($this->entityTableName,$this->webserviceObject,$this->pearDB,$this->user);
		}
	...
	protected function getActorTables(){
		...
		$sql = 'select table_name, webservice_entity_id from mycrm_ws_entity_tables';
