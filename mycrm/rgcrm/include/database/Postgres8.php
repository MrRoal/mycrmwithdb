...
function expandRecord($table,$log)
{
    ...
    //mycrm_activity table
    elseif( $table == "mycrm_activity")
	...
	//mycrm_seactivityrel
	elseif( $table == "mycrm_seactivityrel")
	$subfields = array("crmid", "activityid");

	//mycrm_cntactivityrel
	elseif( $table == "mycrm_cntactivityrel")
	$subfields = array("contactid", "activityid");

	//mycrm_purchaseorder
	elseif( $table == "mycrm_purchaseorder")
	...
	//mycrm_leaddetails
	elseif( $table == "mycrm_leaddetails")
	...
	//mycrm_campaignleadrel
	elseif( $table == "mycrm_campaignleadrel")
	$subfields = array("campaignid", "leadid");

	//mycrm_pricebook
	elseif( $table == "mycrm_pricebook")
