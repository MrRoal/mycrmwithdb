...
require_once 'vtlib/Mycrm/Link.php';
...
class PBXManager extends CRMEntity {
    ...
    var $db;
    var $table_name = 'mycrm_pbxmanager';
    var $table_index = 'pbxmanagerid';
    var $customFieldTable = Array('mycrm_pbxmanagercf', 'pbxmanagerid');
    var $tab_name = Array('mycrm_crmentity', 'mycrm_pbxmanager', 'mycrm_pbxmanagercf');
    var $tab_name_index = Array(
        'mycrm_crmentity' => 'crmid',
        'mycrm_pbxmanager' => 'pbxmanagerid',
        'mycrm_pbxmanagercf' => 'pbxmanagerid');
    var $list_fields = Array(
        /* Format: Field Label => Array(tablename, columnname) */
        // tablename should not have prefix 'mycrm_'
        'Call Status'    => Array('mycrm_pbxmanager', 'callstatus'),
        'Customer' => Array('mycrm_pbxmanager', 'customer'),
        'User' => Array('mycrm_pbxmanager', 'user'),
        'Recording'=> Array('mycrm_pbxmanager', 'recordingurl'),
        'Start Time'=> Array('mycrm_pbxmanager', 'starttime'),
    );
...
//    var $mandatory_fields = Array('assigned_user_id');
    ...
    */
    ...
    function unregisterLookupEvents(){
     ...
     /**
     * To add a link in mycrm_links which is to load our PBXManagerJS.js 
     */
     function addLinksForPBXManager() {
        ...
        Mycrm_Link::addLink($this->tabId, $this->headerScriptLinkType, $this->incominglinkLabel, 'modules/PBXManager/resources/PBXManagerJS.js','','',$handlerInfo);
        $log->fatal('Links added');
    }
    
     /**
     * To remove link for PBXManagerJS.js from mycrm_links
     */
    function removeLinksForPBXManager() {
        global $log;
        //Deleting Headerscripts links
        Mycrm_Link::deleteLink($this->tabId, $this->headerScriptLinkType, $this->incominglinkLabel,'modules/PBXManager/resources/PBXManagerJS.js');
    ...
    */
    function removeSettingsLinks(){
        global $log;
        $adb = PearDatabase::getInstance();
        $adb->pquery('DELETE FROM mycrm_settings_field WHERE name=?', array('LBL_PBXMANAGER'));
    ...
    function removeActionMapping() {
        ...
        $adb->pquery('DELETE FROM mycrm_actionmapping 
