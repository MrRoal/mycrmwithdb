...
class SMSNotifierBase extends CRMEntity {
	...
	var $table_name = 'mycrm_smsnotifier';
	 ...
	 */
	var $customFieldTable = Array('mycrm_smsnotifiercf', 'smsnotifierid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('mycrm_crmentity', 'mycrm_smsnotifier', 'mycrm_smsnotifiercf');
	...
	var $tab_name_index = Array(
		...
		'mycrm_smsnotifier' => 'smsnotifierid',
		'mycrm_smsnotifiercf'=>'smsnotifierid');
	...
	function vtlib_handler($modulename, $event_type) {
        ...
        $SMSNotifierModule  = Mycrm_Module::getInstance('SMSNotifier');
        Mycrm_Access::setDefaultSharing($SMSNotifierModule);
		...
		if($unregisterLinks) {
			...
			$smsnotifierModuleInstance = Mycrm_Module::getInstance('SMSNotifier');
			$smsnotifierModuleInstance->deleteLink("HEADERSCRIPT", "SMSNotifierCommonJS", "modules/SMSNotifier/SMSNotifierCommon.js");

			$leadsModuleInstance = Mycrm_Module::getInstance('Leads');
