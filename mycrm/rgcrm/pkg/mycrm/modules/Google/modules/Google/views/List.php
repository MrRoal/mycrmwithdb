...
class Google_List_View extends Mycrm_PopupAjax_View {
    ...
    function renderWidgetUI(Mycrm_Request $request) {
    ...
    function renderSyncUI(Mycrm_Request $request) {
        $sourceModule = $request->get('sourcemodule');
        $viewer = $this->getViewer($request);
        $viewer->assign('SCRIPTS',$this->getHeaderScripts($request));
        $oauth2 = new Google_Oauth2_Connector($sourceModule); 
    ...
    public function Contacts() {
        ...
        $syncRecords['mycrm']['more'] = $controller->targetConnector->moreRecordsExits();
    ...
    public function getSyncRecordsCount($syncRecords) {
        $countRecords = array('mycrm' => array('update' => 0, 'create' => 0, 'delete' => 0), 'google' => array('update' => 0, 'create' => 0, 'delete' => 0));
