...
class Google_Setting_View extends Mycrm_PopupAjax_View {
    ...
    public function emitContactsSyncSettingUI(Mycrm_Request $request) {
        ...
        $contactsModuleModel = Mycrm_Module_Model::getInstance($request->get('sourcemodule'));
        ...
        $viewer->assign('MYCRM_EMAIL_FIELDS',$emailFields);
        $viewer->assign('MYCRM_PHONE_FIELDS',$phoneFields);
        $viewer->assign('MYCRM_URL_FIELDS',$urlFields);
        $viewer->assign('MYCRM_OTHER_FIELDS',$otherFields);
