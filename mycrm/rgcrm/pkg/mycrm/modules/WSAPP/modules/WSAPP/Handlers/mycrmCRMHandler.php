...
class mycrmCRMHandler extends SyncHandler {
        ...
        foreach ($referenceFieldDetails as $referenceFieldName => $referenceModuleDetails) {
            ...
            foreach ($records as $recordDetails) {
                ...
                if (!empty($referenceWsId)) {
                    ...
                    $webserviceObject = MycrmWebserviceObject::fromId($db, $referenceIdComp[0]);
    ...
    /**
     * Function to fillMandatory fields in mycrm with given values
