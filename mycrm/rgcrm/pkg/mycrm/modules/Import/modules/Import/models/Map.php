...
class Import_Map_Model extends Mycrm_Base_Model {

	static $tableName = 'mycrm_import_maps';
	var $map;
	var $user;
	...
	public static function markAsDeleted($mapId) {
		...
		$db->pquery('UPDATE mycrm_import_maps SET deleted=1 WHERE id=?', array($mapId));
	}
