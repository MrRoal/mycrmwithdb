...
class Documents_ListView_Model extends Mycrm_ListView_Model {
	...
	public function getListViewLinks($linkParams) {
		...
		if($exportPermission) {
			$advancedLink = array(
					...
					'linkurl' => 'javascript:Mycrm_List_Js.triggerExportAction("'.$moduleModel->getExportUrl().'")',
					'linkicon' => ''
			);
	...
	public function getListViewMassActions($linkParams) {
		...
		if ($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'Delete')) {
			$massActionLink = array(
				...
				'linkurl' => 'javascript:Mycrm_List_Js.massDeleteRecords("index.php?module=' . $moduleModel->getName() . '&action=MassDelete");',
				'linkicon' => ''
			);
