 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/mycrm_crm/sugarcrm/modules/Users/Authenticate.php,v 1.10 2005/02/28 05:25:22 jack Exp $
...
if($focus->is_authenticated()) {
	...
	if($audit_trail == 'true') {
		...
		$query = "insert into mycrm_audit_trial values(?,?,?,?,?,?)";
		$params = array($adb->getUniqueID('mycrm_audit_trial'), $focus->id, 'Users','Authenticate','',$date_var);
	...
	$_SESSION['mycrm_authenticated_user_theme'] = $authenticated_user_theme;
	...
	$sql = 'select user_name, id, crypt_type from mycrm_users where user_name=?';
