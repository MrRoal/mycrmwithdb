...
/**
 * Mycrm ListView Model Class
 */
class Mycrm_ListView_Model extends Mycrm_Base_Model {
	...
	public function getSideBarLinks($linkParams) {
		...
		$listLinks = Mycrm_Link_Model::getAllByType($this->getModule()->getId(), $listLinkTypes);
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLinks[] = array(
				...
				'linklabel' => 'LBL_EDIT',
				'linkurl' => 'javascript:Mycrm_List_Js.triggerMassEdit("index.php?module='.$moduleModel->get('name').'&view=MassActionAjax&mode=showMassEditForm");',
				'linkicon' => ''
			);
		}
	...
	public function getListViewHeaders() {
		...
		foreach($headerFields as $fieldName => $webserviceField) {
			...
			$headerFieldModels[$fieldName] = Mycrm_Field_Model::getInstance($fieldName,$module);
		}
	...
	public function getListViewEntries($pagingModel) {
        ...
        if(!empty($orderBy)){
            ...
            if($orderByFieldModel && $orderByFieldModel->getFieldDataType() == Mycrm_Field_Model::REFERENCE_TYPE){
		...
		if(!empty($orderBy)) {
            if($orderByFieldModel && $orderByFieldModel->isReferenceField()){
                ...
                foreach($referenceModules as $referenceModuleName) {
                    $referenceModuleModel = Mycrm_Module_Model::getInstance($referenceModuleName);
	...
	public static function getInstanceForPopup($value) {
		...
		$modelClassName = Mycrm_Loader::getComponentClassName('Model', 'ListView', $value);
		$instance = new $modelClassName();
		$moduleModel = Mycrm_Module_Model::getInstance($value);
	...
	public function getAdvancedLinks(){
		...
		if($duplicatePermission) {
			$advancedLinks[] = array(
				...
				'linkurl' => 'Javascript:Mycrm_List_Js.showDuplicateSearchForm("index.php?module='.$moduleModel->getName().
