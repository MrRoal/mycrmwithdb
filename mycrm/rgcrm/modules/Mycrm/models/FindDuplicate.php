...
class Mycrm_FindDuplicate_Model extends Mycrm_Base_Model {
	...
	function getListViewHeaders() {
		...
		$listViewHeaders[] = new Mycrm_Base_Model(array('name' => 'recordid', 'label' => 'Record Id'));
	...
	function getListViewEntries(Mycrm_Paging_Model $paging) {
        $db = PearDatabase::getInstance();
        $moduleModel = $this->getModule();
    ...
    public function getMassDeleteRecords(Mycrm_Request $request) {
