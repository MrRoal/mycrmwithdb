...
/**
 * Mycrm MenuStructure Model
 */
class Mycrm_MenuStructure_Model extends Mycrm_Base_Model {
	 ...
	 * @return <array> - Associate array of Parent name mapped to Mycrm_Menu_Model instances
	 */
	...
	/**
	 * Function to get an instance of the Mycrm MenuStructure Model from list of menu models
	 * @param <array> $menuModelList - array of Mycrm_Menu_Model instances
	 * @return Mycrm_MenuStructure_Model instance
	 */
	public static function getInstanceFromMenuList($menuModelList, $selectedMenu='') {
		...
		foreach ($menuListArray[self::MORE_MENU_INDEX] as $parent => &$values) {
			uksort($values, array('Mycrm_MenuStructure_Model', 'sortMenuItemsByProcess'));
		}
		//uksort($menuListArray[self::TOP_MENU_INDEX], array('Mycrm_MenuStructure_Model', 'sortMenuItemsByProcess'));
