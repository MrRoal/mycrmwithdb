...
class Mycrm_DetailView_Model extends Mycrm_Base_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if(Users_Privileges_Model::isPermitted($moduleName, 'EditView', $recordId)) {
			...
			$linkModelList['DETAILVIEW'][] = Mycrm_Link_Model::getInstanceFromValues($duplicateLinkModel);
		}
		...
		foreach($relatedLinks as $relatedLinkEntry) {
			$relatedLink = Mycrm_Link_Model::getInstanceFromValues($relatedLinkEntry);
		...
		if($currentUserModel->isAdminUser()) {
			...
			foreach($settingsLinks as $settingsLink) {
				$linkModelList['DETAILVIEWSETTING'][] = Mycrm_Link_Model::getInstanceFromValues($settingsLink);
			}
		}
	...
	public function getSideBarLinks($linkParams) {
		...
		if($currentUser->getTagCloudStatus()) {
			...
			$linkModel = Mycrm_Link_Model::getInstanceFromValues($tagWidget);
	...
	public static function getInstance($moduleName,$recordId) {
		$modelClassName = Mycrm_Loader::getComponentClassName('Model', 'DetailView', $moduleName);
