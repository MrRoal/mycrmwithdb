...
abstract class Mycrm_Basic_View extends Mycrm_Footer_View {
	...
	function preProcess (Mycrm_Request $request, $display=true) {
		...
		$currentDate  = Mycrm_Date_UIType::getDisplayDateValue(date('Y-n-j'));
	...
	function postProcess(Mycrm_Request $request){
		$viewer = $this->getViewer($request);
		//$viewer->assign('GUIDERSJSON', Mycrm_Guider_Model::toJsonList($this->getGuiderModels($request)));
	...
	function getHeaderScripts(Mycrm_Request $request) {
		...
		$jsFileNames = array(
			...
			'~libraries/bootstrap/js/eternicode-bootstrap-datepicker/js/locales/bootstrap-datepicker.'.Mycrm_Language_Handler::getShortLanguageName().'.js',
			'~libraries/jquery/timepicker/jquery.timepicker.min.js',
            'modules.Mycrm.resources.Header',
			'modules.Mycrm.resources.Edit',
			"modules.$moduleName.resources.Edit",
			'modules.Mycrm.resources.Popup',
			"modules.$moduleName.resources.Popup",
			'modules.Mycrm.resources.Field',
			...
			'modules.Mycrm.resources.BasicSearch',
			"modules.$moduleName.resources.BasicSearch",
			'modules.Mycrm.resources.AdvanceFilter',
			"modules.$moduleName.resources.AdvanceFilter",
			'modules.Mycrm.resources.SearchAdvanceFilter',
			"modules.$moduleName.resources.SearchAdvanceFilter",
			'modules.Mycrm.resources.AdvanceSearch',
	...
	function getGuiderModels(Mycrm_Request $request) {
		return array();
	}
