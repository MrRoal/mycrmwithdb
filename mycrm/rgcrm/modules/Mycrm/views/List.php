...
class Mycrm_List_View extends Mycrm_Index_View {
	...
	function preProcess(Mycrm_Request $request, $display=true) {
		...
		$listViewModel = Mycrm_ListView_Model::getInstance($moduleName);
	...
	public function initializeListViewContents(Mycrm_Request $request, Mycrm_Viewer $viewer) {
		...
		$viewer->assign('GROUPS_IDS', Mycrm_Util_Helper::getGroupsIdsForUsers($currentUser->getId()));
    ...
    public function transferListSearchParamsToFilterCondition($listSearchParams, $moduleModel) {
        return Mycrm_Util_Helper::transferListSearchParamsToFilterCondition($listSearchParams, $moduleModel);
    }
}