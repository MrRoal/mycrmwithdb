 ...
 * All Rights Reserved.
 *************************************************************************************/
Mycrm_Base_Validator_Js("Mycrm_Email_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var emailInstance = new Mycrm_Email_Validator_Js();
...
Mycrm_Base_Validator_Js("Mycrm_PositiveNumber_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var positiveNumberInstance = new Mycrm_PositiveNumber_Validator_Js();
...
Mycrm_Base_Validator_Js("Mycrm_Integer_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var integerInstance = new Mycrm_Integer_Validator_Js();
...
Mycrm_PositiveNumber_Validator_Js("Mycrm_Percentage_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var percentageInstance = new Mycrm_Percentage_Validator_Js();
...
Mycrm_Base_Validator_Js('Mycrm_Url_Validator_Js',{},{
...
Mycrm_Base_Validator_Js("Mycrm_MultiSelect_Validator_Js",{

	invokeValidation : function(field, rules, i, options) {
		var validatorInstance = new Mycrm_MultiSelect_Validator_Js ();
...
Mycrm_Email_Validator_Js ("Mycrm_MultiEmails_Validator_Js",{
	invokeValidation : function(field) {
		var validatorInstance = new Mycrm_MultiEmails_Validator_Js ();
		validatorInstance.setElement(field);
		var result = validatorInstance.validate();
		if(!result){
			return validatorInstance.getError();
...
Mycrm_PositiveNumber_Validator_Js("Mycrm_GreaterThanZero_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var GreaterThanZeroInstance = new Mycrm_GreaterThanZero_Validator_Js();
...
Mycrm_PositiveNumber_Validator_Js("Mycrm_WholeNumber_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new Mycrm_WholeNumber_Validator_Js();
...
Mycrm_Base_Validator_Js("Mycrm_lessThanToday_Validator_Js",{},{
	...
	validate: function(){
		...
		var fieldValue = this.getFieldValue();
		try{
			var fieldDateInstance = Mycrm_Helper_Js.getDateInstance(fieldValue,fieldDateFormat);
		}
		catch(err){
			this.setError(err);
			return false;
...
Mycrm_Base_Validator_Js("Mycrm_lessThanOrEqualToToday_Validator_Js",{},{
...
Mycrm_Base_Validator_Js('Mycrm_greaterThanOrEqualToToday_Validator_Js',{},{
...
Mycrm_Base_Validator_Js("Mycrm_greaterThanDependentField_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var instance = new Mycrm_greaterThanDependentField_Validator_Js();
		instance.setElement(field);
	...
	getDateTimeInstance : function(field) {
		...
		try{
			var dateTimeInstance = Mycrm_Helper_Js.getDateInstance(fieldValue,dateFormat);
		}
		catch(err){
			this.setError(err);
			return false;
...
Mycrm_Base_Validator_Js("Mycrm_futureEventCannotBeHeld_Validator_Js",{},{
	...
	validate: function(dependentFieldList){
		...
		for(var i=0; i<dependentFieldList.length; i++){
			...
			if(dependentFieldInContext.length > 0){
				...
				var dependentFieldDateInstance = Mycrm_Helper_Js.getDateInstance(fieldValue,dateFormat);
...
Mycrm_Base_Validator_Js("Mycrm_lessThanDependentField_Validator_Js",{},{
...
Mycrm_Base_Validator_Js('Mycrm_Currency_Validator_Js',{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var currencyValidatorInstance = new Mycrm_Currency_Validator_Js();
...
Mycrm_Base_Validator_Js("Mycrm_ReferenceField_Validator_Js",{},{
...
Mycrm_Integer_Validator_Js("Mycrm_Double_Validator_Js",{},{
...
Mycrm_Base_Validator_Js("Mycrm_Date_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var dateValidatorInstance = new Mycrm_Date_Validator_Js();
	...
	validate: function(){
		...
		var fieldValue = this.getFieldValue();
		try{
			Mycrm_Helper_Js.getDateInstance(fieldValue,fieldDateFormat);
		}
		catch(err){
...
Mycrm_Base_Validator_Js("Mycrm_Time_Validator_Js",{
	 ...
	 */
	invokeValidation : function(field, rules, i, options) {
		var validatorInstance = new Mycrm_Time_Validator_Js();
		validatorInstance.setElement(field);
		var result = validatorInstance.validate();
		if(result == true){
			return result;
...
Mycrm_greaterThanDependentField_Validator_Js("Calendar_greaterThanDependentField_Validator_Js",{},{
	...
	getDateTimeInstance : function(field) {
        ...
        var dateFormat = field.data('dateFormat');
        return Mycrm_Helper_Js.getDateInstance(dateFieldValue,dateFormat);
	}

});

Mycrm_Base_Validator_Js('Calendar_greaterThanToday_Validator_Js',{},{
...
Mycrm_Base_Validator_Js("Calendar_RepeatMonthDate_Validator_Js",{
...
Mycrm_WholeNumber_Validator_Js("Mycrm_WholeNumberGreaterThanZero_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var WholeNumberGreaterThanZero = new Mycrm_WholeNumberGreaterThanZero_Validator_Js();
...
Mycrm_Base_Validator_Js("Mycrm_AlphaNumeric_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var alphaNumericInstance = new Mycrm_AlphaNumeric_Validator_Js();
