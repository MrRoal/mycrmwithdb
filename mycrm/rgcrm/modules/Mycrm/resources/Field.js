...
jQuery.Class("Mycrm_Field_Js",{
	...
	getUiTypeModel : function() {
		...
		var BasicUiTypeClassName = window["Mycrm_"+ typeClassName + "_Field_Js"];
	...
	addValidationToElement : function(element) {
		...
		validationHandler +="funcCall[Mycrm_Base_Validator_Js.invokeValidation]]";
...
Mycrm_Field_Js('Mycrm_Picklist_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Multipicklist_Field_Js',{},{
	/**
	 * Function to get the pick list values
	 * @return <object> key value pair of options
	 */
...
Mycrm_Field_Js('Mycrm_Date_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Currency_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Owner_Field_Js',{},{
...
Mycrm_Date_Field_Js('Mycrm_Datetime_Field_Js',{},{

});

Mycrm_Field_Js('Mycrm_Time_Field_Js',{},{
...
Mycrm_Field_Js('Mycrm_Recurrence_Field_Js',{},{
