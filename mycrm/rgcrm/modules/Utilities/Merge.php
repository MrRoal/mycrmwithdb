...
// Fix For: http://trac.mycrm.com/cgi-bin/trac.cgi/ticket/2107
...
$sql = "select filename,data,filesize from mycrm_wordtemplatestorage where filename=?";
...
<OBJECT Name="mycrmVM" codebase="http://<?php echo $_SERVER["HTTP_HOST"] ?>/modules/Settings/mycrmVM.CAB#Version1,0,0,1"
