...
class PriceBooks_Relation_Model extends Mycrm_Relation_Model{
	...
	public function getQuery($recordModel, $actions=false){
		...
		if($functionName == ('get_pricebook_products' || 'get_pricebook_services')){
			$selectColumnSql = $selectColumnSql.', mycrm_pricebookproductrel.listprice';
		}
	...
	public function addListPrice($sourceRecordId, $destinationRecordId, $listPrice) {
		...
		$priceBookModel = Mycrm_Record_Model::getInstanceById($sourceRecordId, $sourceModuleName);
