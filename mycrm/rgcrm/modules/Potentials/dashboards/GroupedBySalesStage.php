...
class Potentials_GroupedBySalesStage_Dashboard extends Mycrm_IndexAjax_View {
	...
	public function process(Mycrm_Request $request) {
		...
		if(!empty($dates)) {
			$dates['start'] = Mycrm_Date_UIType::getDBInsertedValue($dates['start']);
			$dates['end'] = Mycrm_Date_UIType::getDBInsertedValue($dates['end']);
		}
