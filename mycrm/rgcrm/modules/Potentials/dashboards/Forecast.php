...
class Potentials_Forecast_Dashboard extends Mycrm_IndexAjax_View {
	...
	public function process(Mycrm_Request $request) {
		...
		if(!empty($expectedclosedate)) {
			$closingdates['start'] = Mycrm_Date_UIType::getDBInsertedValue($expectedclosedate['start']);
			$closingdates['end'] = Mycrm_Date_UIType::getDBInsertedValue($expectedclosedate['end']);
		}
