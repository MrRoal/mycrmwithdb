 ...
 */
class Calendar_ListView_Model extends Mycrm_ListView_Model {
	...
	public function getListViewHeaders() {
		...
		foreach($headerFields as $fieldName => $webserviceField) {
            ...
            $fieldInstance = Mycrm_Field_Model::getInstance($fieldName,$module);
            if(!$fieldInstance) {
                if($moduleName == 'Calendar') {
                    $eventmodule = Mycrm_Module_Model::getInstance('Events');
                    $fieldInstance = Mycrm_Field_Model::getInstance($fieldName,$eventmodule);
                }
            }
