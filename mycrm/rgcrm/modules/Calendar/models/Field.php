 ...
 */
class Calendar_Field_Model extends Mycrm_Field_Model {
	...
	*/
    ...
    public static function getReccurencePicklistValues() {
		$currentUser = Users_Record_Model::getCurrentUserModel();
		$fieldModel = Mycrm_Field_Model::getInstance('recurringtype', Mycrm_Module_Model::getInstance('Events'));
		if($fieldModel->isRoleBased() && !$currentUser->isAdminUser()) {
			$userModel = Users_Record_Model::getCurrentUserModel();
			$picklistValues = Mycrm_Util_Helper::getRoleBasedPicklistValues('recurringtype', $userModel->get('roleid'));
		}else{
			$picklistValues = Mycrm_Util_Helper::getPickListValues('recurringtype');
		}
