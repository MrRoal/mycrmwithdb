...
class PBXManager_PBXManager_Connector {
    ...
    private static $SETTINGS_REQUIRED_PARAMETERS = array('webappurl' => 'text','outboundcontext' => 'text', 'outboundtrunk' => 'text' , 'mycrmsecretkey' => 'text');
    ...
    public function getMycrmSecretKey() {
        return $this->mycrmsecretkey;
    }
    ...
    public function setServerParameters($serverModel) {
        ...
        $this->mycrmsecretkey = $serverModel->get('mycrmsecretkey');
    }
