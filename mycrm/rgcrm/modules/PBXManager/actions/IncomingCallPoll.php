...
class PBXManager_IncomingCallPoll_Action extends Mycrm_Action_Controller{
    ...
    public function checkModuleViewPermission(Mycrm_Request $request){
    ...
    public function searchIncomingCalls(Mycrm_Request $request){
   ...
   public function createRecord(Mycrm_Request $request){
            $user = Users_Record_Model::getCurrentUserModel();
            ...
            foreach($mandatoryFieldModels as $mandatoryField){
                ...
                if(!empty($element[$fieldName])){
                    ...
                    if(empty($fieldValue)) {
                        $fieldValue = Mycrm_Util_Helper::getDefaultMandatoryValue($fieldType);
                    }
    ...
    function checkPermissionForPolling(Mycrm_Request $request) {
        Users_Privileges_Model::getCurrentUserPrivilegesModel();
