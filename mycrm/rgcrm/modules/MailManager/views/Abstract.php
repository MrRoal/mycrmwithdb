...
abstract class MailManager_Abstract_View extends Mycrm_Index_View {
	 ...
	 */
	public function getViewer(Mycrm_Request $request) {
	 ...
	 * @return type
	 */
	public function getOperationArg(Mycrm_Request $request) {
