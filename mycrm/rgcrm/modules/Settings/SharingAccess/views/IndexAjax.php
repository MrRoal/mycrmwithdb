...
Class Settings_SharingAccess_IndexAjax_View extends Settings_Mycrm_IndexAjax_View {
	...
	public function showRules(Mycrm_Request $request) {
	...
	public function editRule(Mycrm_Request $request) {
