...
class Settings_Workflows_RecordStructure_Model extends Mycrm_RecordStructure_Model {
	...
	public static function getInstanceForWorkFlowModule($workFlowModel, $mode) {
		$className = Mycrm_Loader::getComponentClassName('Model', $mode.'RecordStructure', 'Settings:Workflows');
