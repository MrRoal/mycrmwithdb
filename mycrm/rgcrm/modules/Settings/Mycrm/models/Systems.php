...
class Settings_Mycrm_Systems_Model extends Mycrm_Base_Model{

    const tableName = 'mycrm_systems';
    ...
    public static function getInstanceFromServerType($type,$componentName) {
        ...
        try{
        $modelClassName = Mycrm_Loader::getComponentClassName('Model', $componentName, 'Settings:Mycrm');
        }catch(Exception $e) {
            $modelClassName = self;
        }
