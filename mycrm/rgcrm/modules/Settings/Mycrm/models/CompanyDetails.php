...
class Settings_Mycrm_CompanyDetails_Model extends Settings_Mycrm_Module_Model {

	STATIC $logoSupportedFormats = array('jpeg', 'jpg', 'png', 'gif', 'pjpeg', 'x-png');

	var $baseTable = 'mycrm_organizationdetails';
	...
	public function getEditViewUrl() {
		return 'index.php?module=Mycrm&parent=Settings&view=CompanyDetailsEdit';
	}
	...
	public function getMenuItem() {
		$menuItem = Settings_Mycrm_MenuItem_Model::getInstance('LBL_COMPANY_DETAILS');
		return $menuItem;
	}
	...
	public function getIndexViewUrl() {
		...
		return 'index.php?module=Mycrm&parent=Settings&view=CompanyDetails&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
	 ...
	 * @return <Settings_Mycrm_CompanyDetais_Model> $moduleModel
	 */
	public static function getInstance() {
		$moduleModel = new self();
		$db = PearDatabase::getInstance();

		$result = $db->pquery("SELECT * FROM mycrm_organizationdetails", array());
       ...
       public static function getSetting($fieldname) { 
            global $adb; 
            if (!self::$settings) { 
                    self::$settings = $adb->database->GetRow("SELECT * FROM mycrm_organizationdetails"); 
            } 
