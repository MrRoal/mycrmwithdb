 ...
 */
class Settings_Mycrm_Menu_Model extends Mycrm_Base_Model {

	protected static $menusTable = 'mycrm_settings_blocks';
	...
	public function getListUrl() {
		return 'index.php?module=Mycrm&parent=Settings&view=ListMenu&block='.$this->getId();
	}
	...
	public function getItems() {
		return Settings_Mycrm_MenuItem_Model::getAll($this);
	}
	...
	public static function getAll() {
		...
		for($i=0; $i<$noOfMenus; ++$i) {
			...
			$menuModels[$blockId] = Settings_Mycrm_Menu_Model::getInstanceFromArray($rowData);
		}
		return $menuModels;
	}
	...
	public static function getInstanceById($id) {
		...
		if($db->num_rows($result) > 0) {
			...
			return Settings_Mycrm_Menu_Model::getInstanceFromArray($rowData);
		}
		return false;
	}
