...
class Settings_Picklist_SaveAjax_Action extends Settings_Mycrm_Basic_Action {
    ...
    public function updateDefaultPicklistValues($pickListFieldName,$oldValue,$newValue) {
        $db = PearDatabase::getInstance();            
            ...
            $queryToGetId = 'SELECT id FROM mycrm_users WHERE '.$defaultFieldName.' IN (';
            ...
            for($i=0; $i<$rowCount; $i++) {
                ...
                $record = Mycrm_Record_Model::getInstanceById($recordId, 'Users');
    ...
    public function rename(Mycrm_Request $request) {
        $moduleName = $request->get('source_module');
    ...
    public function remove(Mycrm_Request $request) {
        $moduleName = $request->get('source_module');
     ...
     */
    public function assignValueToRole(Mycrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function saveOrder(Mycrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function enableOrDisable(Mycrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
