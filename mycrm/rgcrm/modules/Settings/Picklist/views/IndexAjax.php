...
class Settings_Picklist_IndexAjax_View extends Settings_Mycrm_IndexAjax_View {
    ...
    public function showEditView(Mycrm_Request $request) {
	...
	//	$selectedFieldAllPickListValues =  array_map('Mycrm_Util_Helper::toSafeHTML', $selectedFieldAllPickListValues);
    ...
    public function showDeleteView(Mycrm_Request $request) {
        $module = $request->get('source_module');
        $pickListFieldId = $request->get('pickListFieldId');
        $fieldModel = Settings_Picklist_Field_Model::getInstance($pickListFieldId);
		...
		$selectedFieldEditablePickListValues = $fieldModel->getEditablePicklistValues($fieldModel->getName());
		$selectedFieldNonEditablePickListValues = $fieldModel->getNonEditablePicklistValues($fieldModel->getName());
		$selectedFieldEditablePickListValues =  array_map('Mycrm_Util_Helper::toSafeHTML', $selectedFieldEditablePickListValues);
		if(!empty($selectedFieldNonEditablePickListValues)) {
			$selectedFieldNonEditablePickListValues =  array_map('Mycrm_Util_Helper::toSafeHTML', $selectedFieldNonEditablePickListValues);
		}
		...
		$viewer->assign('SELECTED_PICKLISTFIELD_EDITABLE_VALUES',$selectedFieldEditablePickListValues);
		$viewer->assign('SELECTED_PICKLISTFIELD_NON_EDITABLE_VALUES',$selectedFieldNonEditablePickListValues);
		$viewer->assign('FIELD_VALUES',array_map('Mycrm_Util_Helper::toSafeHTML', $valueToDelete));
        echo $viewer->view('DeleteView.tpl', $qualifiedName, true);
    }

    public function getPickListDetailsForModule(Mycrm_Request $request) {
    ...
    public function getPickListValueForField(Mycrm_Request $request) {
        $sourceModule = $request->get('source_module');
        ...
        $selectedFieldAllPickListValues = Mycrm_Util_Helper::getPickListValues($fieldModel->getName());
        $viewer = $this->getViewer($request);
    ...
    public function getPickListValueByRole(Mycrm_Request $request) {
        $sourceModule = $request->get('source_module');
        $pickFieldId = $request->get('pickListFieldId');
        $fieldModel = Settings_Picklist_Field_Model::getInstance($pickFieldId);
        $moduleName = $request->getModule();
		...
		$pickListValuesForRole = array_map('Mycrm_Util_Helper::toSafeHTML', $pickListValuesForRole);
        $allPickListValues = Mycrm_Util_Helper::getPickListValues($fieldModel->getName());
		$allPickListValues =  array_map('Mycrm_Util_Helper::toSafeHTML', $allPickListValues);
     ...
     */
    public function showAssignValueToRoleView(Mycrm_Request $request) {
		$sourceModule = $request->get('source_module');
        $pickFieldId = $request->get('pickListFieldId');
        $fieldModel = Settings_Picklist_Field_Model::getInstance($pickFieldId);
