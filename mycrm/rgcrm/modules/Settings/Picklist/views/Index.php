...
class Settings_Picklist_Index_View extends Settings_Mycrm_Index_View {
    ...
    public function process(Mycrm_Request $request) {
        ...
        if(count($pickListFields) > 0) {
            ...
            $selectedFieldAllPickListValues = Mycrm_Util_Helper::getPickListValues($selectedPickListFieldModel->getName());
