...
class Contacts_ListView_Model extends Mycrm_ListView_Model {
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLink = array(
				...
				'linkurl' => 'javascript:Mycrm_List_Js.triggerTransferOwnership("index.php?module='.$moduleModel->getName().'&view=MassActionAjax&mode=transferOwnership")',
				'linkicon' => ''
			);
			$massActionLinks['LISTVIEWMASSACTION'][] = Mycrm_Link_Model::getInstanceFromValues($massActionLink);
		}
