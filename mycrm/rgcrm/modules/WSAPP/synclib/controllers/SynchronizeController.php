...
require_once 'modules/WSAPP/synclib/connectors/MycrmConnector.php';
...
abstract class WSAPP_SynchronizeController {
	...
	function getSourceConnector() {
		$connector =  new WSAPP_MycrmConnector();
		...
		return $connector->setName('Mycrm_'.$targetName);
	}
	...
	function getSourceRecordModel($data) {
		return new WSAPP_MycrmModel($data);
	}
