 ...
 */
class Inventory_Record_Model extends Mycrm_Record_Model {
	 ...
	 * @return <Model> returns Mycrm_Record_Model
	 */
	 ...
	 * @param Mycrm_Record_Model $parentRecordModel
	 * @return Inventory_Record_Model
	 */
	public function setParentRecordData(Mycrm_Record_Model $parentRecordModel) {
		...
		foreach ($fieldMappingList as $fieldMapping) {
            ...
            $fieldModel = Mycrm_Field_Model::getInstance($parentField,  Mycrm_Module_Model::getInstance($moduleName));
	...
	public function getPDF() {
		...
		$controllerClassName = "Mycrm_". $moduleName ."PDFController";
    ...
    public function getPDFFileName() {
		...
		if ($moduleName == 'Quotes') {
			...
			$controllerClassName = "Mycrm_QuotePDFController";
		} else {
