<?php /* Smarty version Smarty-3.1.7, created on 2018-06-28 12:16:49
         compiled from "/home/ilogix/Workspace/freshvtiger/rgcrm/includes/runtime/../../layouts/vlayout/modules/Mycrm/EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8740988435b34d1b1c1acb3-00594272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'daa989e8d30acb7d85f6e942376a696c646fe62b' => 
    array (
      0 => '/home/ilogix/Workspace/freshvtiger/rgcrm/includes/runtime/../../layouts/vlayout/modules/Mycrm/EditViewBlocks.tpl',
      1 => 1530184629,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8740988435b34d1b1c1acb3-00594272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34d1b1dec25',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34d1b1dec25')) {function content_5b34d1b1dec25($_smarty_tpl) {?>

<div class='container-fluid editViewContainer'><form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data"><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'), null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Mycrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
