<?php /* Smarty version Smarty-3.1.7, created on 2018-06-28 12:03:15
         compiled from "/home/ilogix/Workspace/freshvtiger/rgcrm/includes/runtime/../../layouts/vlayout/modules/Users/SystemSetup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20232396225b34ce83d7b805-46304697%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '815326a6425048509ba7c9a2a7f9b01541211f91' => 
    array (
      0 => '/home/ilogix/Workspace/freshvtiger/rgcrm/includes/runtime/../../layouts/vlayout/modules/Users/SystemSetup.tpl',
      1 => 1530184632,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20232396225b34ce83d7b805-46304697',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34ce83de9e8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34ce83de9e8')) {function content_5b34ce83de9e8($_smarty_tpl) {?>
<html lang="en"><head><title>Mycrm CRM Setup</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link REL="SHORTCUT ICON" HREF="layouts/vlayout/skins/images/favicon.ico"><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap.css" type="text/css" media="screen" /><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap-responsive.css" type="text/css" media="screen"><style type="text/css">
                    body{
                ...
                </script><div class="container-fluid page-container"><div class="row-fluid"><div class="span6"><div class="logo"><img src="test/logo/mycrm-crm-logo.png" alt="Mycrm Logo"/></div></div><div class="span6"></div></div><div class="row-fluid main-container"><div class="span12 inner-container"><div class="row-fluid"><div class="span8"><h3 style="display: inline-block;float:left;"> What would you like to use Mycrm CRM for? </h3><p style="display: inline-block;float:left;margin-top:4px;">&nbsp;&nbsp;(Select features you want to enable)</p></div><div class="span4"><div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong> Select All</strong></label> <input type="checkbox" name="selectAll" class="selectAll"/><div class="chkbox"></div></div></div></div><hr><form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['PACKAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PACKAGE_INFO']->_loop = false;
...
" alt="Mycrm Logo"/></div><div class="<?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0){?> span10 <?php }else{ ?> span9 <?php }?>"><div class="group-heading"><h4><?php echo $_smarty_tpl->tpl_vars['PACKAGE_INFO']->value['label'];?>
