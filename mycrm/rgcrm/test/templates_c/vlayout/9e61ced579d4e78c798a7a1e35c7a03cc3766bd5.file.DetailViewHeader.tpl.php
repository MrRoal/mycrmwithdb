<?php /* Smarty version Smarty-3.1.7, created on 2018-06-28 12:17:22
         compiled from "/home/ilogix/Workspace/freshvtiger/rgcrm/includes/runtime/../../layouts/vlayout/modules/Mycrm/DetailViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16039597305b34d1d2e615c8-30879309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9e61ced579d4e78c798a7a1e35c7a03cc3766bd5' => 
    array (
      0 => '/home/ilogix/Workspace/freshvtiger/rgcrm/includes/runtime/../../layouts/vlayout/modules/Mycrm/DetailViewHeader.tpl',
      1 => 1530184629,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16039597305b34d1d2e615c8-30879309',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34d1d2f155e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34d1d2f155e')) {function content_5b34d1d2f155e($_smarty_tpl) {?>
...
_detailView_basicAction_<?php echo Mycrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel());?>
...
_detailView_moreAction_<?php echo Mycrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
...
' method="POST"><?php if (!empty($_smarty_tpl->tpl_vars['PICKLIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value="<?php echo Mycrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_DEPENDENCY_DATASOURCE']->value);?>
